...
if __name__ == "__main__":
    ...
    # if not os.path.exists("countries_of_the_world.csv"):
    #     old_dataset = pd.read_csv("countries_of_the_world_old.csv")
    #     dataProcess(old_dataset)
    # raw_dataset = pd.read_csv("countries_of_the_world.csv")
